...
export default defineAppConfig({
  ...
  ui: {
    ...
    ring: 'focus-visible:ring-2 focus-visible:ring-{color}-500 dark:focus-visible:ring-{color}-400 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-gray-700',
    active: 'bg-{color}-500 dark:bg-{color}-400',
    inactive: 'bg-gray-700 dark:bg-gray-700',
    size: {
      '2xs': 'h-3 w-5',
      xs: 'h-3.5 w-6',
      sm: 'h-4 w-7',
    ...
    icon: {
      ...
      off: 'text-gray-50 dark:text-gray-50',
